...
from manifest_types import manifest_desc
import json
...
def manifest_data(mfxml):
    ...
    try:
        logging.info("Extracting Manifest Data")
        svc = []
        act = []
        brd = []
        cnp = []
        ...
        logging.error(traceback.format_exc())
        raise AuditorException("Extracting Manifest Data")
...
def manifest_analysis(mfxml, man_data_dic):
    ...
    try:
        logging.info("Manifest Analysis Started")
                        ...
                        if is_inf:
                            ...
                            if item != man_data_dic['mainactivity']:
                                if is_perm_exist:
                                    ...
                                    if node.getAttribute("android:permission") in permission_dict:
                                        ...
                                        if prot_level_exist:
                                            if protlevel == 'normal':
                                                ...
                                                ret_list.append(
                                                    ("a_prot_sign", (itemname, item, perm + prot,),
                                                     (an_or_a, itemname,),))
                                            elif protlevel == 'signatureOrSystem':
                                                ret_list.append(
                                    ...
                                    if perm_appl_level_exists is False:
                                        ret_list.append(
                                            ("a_not_protected_filter", (itemname, item,),
                                    ...
                                    if is_perm_exist:
                                        ...
                                        if prot_level_exist:
                                            if protlevel == 'normal':
                                                ...
                                                ret_list.append(
                                                    ("c_prot_sign", (itemname, item, perm + prot,),
                                                     (an_or_a, itemname,),))
                                            elif protlevel == 'signatureOrSystem':
                                                ret_list.append(
                                        ...
                                        if perm_appl_level_exists is False:
                                            ...
                                            if prot_level_exist:
                                                ...
                                                ret_list.append(
                                                    ("c_prot_unknown_appl", (itemname, item, perm),
                                                     (an_or_a, itemname,),))
                                                exp_count[cnt_id] = exp_count[
                                                                        cnt_id] + 1
                                    ...
                                    if itemname == 'Content Provider' and int(man_data_dic['target_sdk']) >= 17:
                                        ...
                                        if is_perm_exist:
                                            ...
                                            if prot_level_exist:
                                                if protlevel == 'normal':
                                                    ret_list.append(
                                                        ("c_prot_normal_new", (itemname, item, perm + prot,),
                                                         (itemname,),))
                                                    exp_count[cnt_id] = exp_count[
                                                                            cnt_id] + 1
                                                if protlevel == 'dangerous':
                                                    ret_list.append(
                                                        ("c_prot_danger_new", (itemname, item, perm + prot,),
                                                         (itemname,),))
                                                    exp_count[cnt_id] = exp_count[
                                                                            cnt_id] + 1
                                                if protlevel == 'signature':
                                                    ret_list.append(
                                                        ("c_prot_sign_new", (itemname, item, perm + prot,),
                                                         (itemname,),))
